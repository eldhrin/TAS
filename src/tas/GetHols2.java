        ...
        for(File file : files){
            ...
            try {
                ...
                if(cursor.hasNext()){
                    ...
                    Cell carried = wb.getSheetAt(1).getRow(8).getCell(1, xc.RETURN_BLANK_AS_NULL);
                    Double ccarried = 0.0;
                    ...
                    for(int i = 18; i < 30; i++){
                        Cell req = wb.getSheetAt(1).getRow(i).getCell(0, xc.RETURN_BLANK_AS_NULL);
                        ...
                        //if the cell is not null then there is a date, process it
                            ...
                            Cell cdays = wb.getSheetAt(1).getRow(i).getCell(2, xc.RETURN_BLANK_AS_NULL);
                            Double days = 0.0;
